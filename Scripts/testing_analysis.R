...
#Data#
######
tests <- c(1296, 1751, 2271, 3132, 4091, 5207, 6004, 8922, 13749, 19794, 23621, 29371, 35049, 39066, 42793, 46935, 51738, 56608, 62962) #taken from PDFs
...
plot(as.POSIXct(strptime(diff_mat[start:stop,1], format = "%Y-%m-%d")) , rowSums(diff_mat[,-1], na.rm = T)[start:stop]/diff(tests), type = "b", ylim = c(0, 0.25), pch = 16, lwd = 2, bty = "n", xlab = "", ylab = "Proportion of tests positive", main = "COVID-19 positive test prop. in MA")
