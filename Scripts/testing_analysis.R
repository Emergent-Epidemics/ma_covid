...
#Data#
######
tests <- c(1296, 1751, 2271, 3132, 4091, 5207, 6004, 8922, 13749, 19794, 23621, 29371, 35049, 39066, 42793, 46935, 51738, 56608, 62962, 68800,71937,76429,81344,87511,94958,102372, 108776,116730, 122049, 126551, 132023, 140773, 148744, 156806, 162241) #taken from PDFs, last updated for Apr 17th
